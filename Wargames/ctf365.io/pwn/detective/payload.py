...
so exit does a bit of stuff before it actually exists.
try walking through it, you might find something interesting...
'''
'''
...
#+--------------SET_UP------------------------+
context.binary = './detective'
conn = process('./detective')
#+--------------------------------------------+
